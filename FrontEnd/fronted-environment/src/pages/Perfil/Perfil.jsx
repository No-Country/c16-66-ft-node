...
export default function Perfil() {
	...
	return (
		<main className='flex flex-col w-screen h-screen box-border z-0 border-2'>
			...
			<section
				style={{ marginLeft: "17%", marginTop: "1%", maxHeight: "100vh" }}
				className='h-full bg-bgLightGreen w-inherit  border-2'
			>
				...
				<div className='flex overflow-x-auto p-1 w-full h-12 mb-4'>
					<button
						...
						className='items-center p-1 rounded-xl bg-white hover:bg-mostLighthBlue mr-1 flex text-xs w-fit'
					>
						<img src={personEdit} className='h-5' />
					...
					<button
						...
						className='items-center p-1 rounded-xl bg-white hover:bg-mostLighthBlue mr-1 flex text-xs w-fit'
					>
						<img src={matricula} className='h-5' />
						Mi matrícula
					</button>
					<button
						...
						className='items-center p-1 rounded-xl bg-white hover:bg-mostLighthBlue mr-1 flex text-xs w-fit'
					>
						<img src={historial} className='h-5' />
