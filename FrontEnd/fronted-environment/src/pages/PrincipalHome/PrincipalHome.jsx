        ...
        <div className='w-screen h-screen overflow-y-scroll'>
            ...
            <main className='h-fit w-full mx-auto mt-4 xl:mt-8 xl:py-6 xl:px-10'>
                <section className='w-full px-6 mx-auto h-fit p-2'>
                    <h2 className='font-bold text-base lg:text-lg xl:text-xl text-black'>¿Con qué tipo de especialistas contamos?</h2>
                    <br/>
                    <p className='text-base lg:text-lg xl:text-xl mt-1 xl:mt-4'>En MedConnect contamos con atención en más de 30 especialidades y más de mil médicos estaán a tu servicio como: psicologos, dermatólogos, oftalmólogos, urólogos, ortopedistas, pediatras, psiquiatras y muchos más. </p>
                </section>
                <section className='mt-4 h-fit xl:mt-8 p-2'>
                    <h2 className='font-bold text-base lg:text-lg xl:text-xl text-black pl-6'>Beneficios que ofrecemos</h2>
