        ...
        <div className='w-screen h-screen overflow-y-scroll'>
            ...
            <main className='h-fit w-full mx-auto mt-4 xl:mt-8'>
                ...
                <section className='mt-4 h-fit xl:mt-8'>
                    ...
                    <div className='mt-2 xl:mt-8 w-96 sm:w-2/3 p-1 mx-auto flex overflow-x-scroll rounded-md md:w-5/6 lg:border-none lg:pt-0 lg:justify-around h-1/3 lg:w-full lg:h-2/5 xl:h-1/2 lg:overflow-visible'>
                ...
                <section className='mt-4 xl:mt-8 h-fit'>
                    ...
                    <div className='mx-auto w-10/12 h-fit mt-4 xl:mt-8 flex justify-center flex-wrap lg:flex-nowrap lg:max-w-10/12 lg:overflow-x-auto lg:w-11/12 lg:place-content-start xl:w-full xl:m-0 xl:place-content-center'>
