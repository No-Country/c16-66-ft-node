            ...
            <section className='h-fit  w-ful'>
                <div className='flex flex-col-reverse xl:flex-row xl:justify-around items-center h-fit xl:m-auto'>
                    ...
                    <div className='flex flex-col items-starts pb-4 w-fit sm:w-auto sm:pb-0'>
                        ...
                        <RegisterButton text={'Registrate'} arrowDown={arrowDown} className={`text-xs flex flex-wrap hover:text-darkBlue`} className2={`text-xs flex flex-col items-start mb-1`} btn={`hover:text-darkBlue`}/>

                        <Link to='/autogestion' className='text-xs flex flex-wrap hover:text-darkBlue'>  <img src={vector} className='w-2 pr-1' /> Iniciar sesión </Link>
                        
                        <Link to='/medical-list' className='text-xs flex flex-wrap hover:text-darkBlue'>  <img src={vector} className='w-2 pr-1' /> Cartilla médica </Link>
                    ...
                    <div className='flex flex-col items-starts pb-4 sm:pb-0 w-fit'>
                        ...
                        <hr className='text-black h-2 w-11/12'/>
                        <p className='text-xs flex flex-wrap hover:text-darkBlue'>  <img src={vector} className='pr-1 w-2' /> Aviso legal</p>
                        <p className='text-xs flex flex-wrap hover:text-darkBlue'>  <img src={vector} className='pr-1 w-2' /> Políticas de privacidad</p>
                        <p className='text-xs flex flex-wrap hover:text-darkBlue'>  <img src={vector} className='pr-1 w-2' /> Términos y condiciones</p>
                    </div>
                </section>
