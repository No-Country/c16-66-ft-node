...
export function AsideComponent() {
	...
	return (
		<div
			className='asideContainerLg flex-col flex items-start gap-10 justify-between'
			style={{ width: !openClose ? "120px" : "264px" }}
		>
			<div className='flex-col flex'>
				<div className='flex p-4 gap-4 flex-col'>
					...
					<div className='flex flex-nowrap mt-2'>
						<Button>
							<img className='w-10 h-10' src={isotipo} />
						</Button>
						<div
							style={{ display: openClose ? "block" : "none" }}
							className='flex-wrap textHiddenAside'
						>
